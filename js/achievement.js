...
function TargetAPE() {
  ...
  .get().then((snapshot)=> {
    ...
    str += '<div class="bar_background"><div style="padding-top:8px;"><div class="bar_body">กรกฎาคม</div>';
...
function Achievement() {
  var str = "";
  str += '<div class="btn-t33" style="margin-top:30px; background-color: #94a9b3;border: solid #94a9b3 1px;">เป้าหมาย % Achievement<br> เดือนกรกฎาคม 2565</div>';
  dbBBDRH.orderBy('EmpRH','asc')
  .get().then((snapshot)=> {
    snapshot.forEach(doc=> {
      ...
      str += '<div class="bar_body1">'+ doc.data().Achieve_1 +'</div>';
